...
- **"Stale harness copies" (raised in the 2026-09-21 closeout instruction) — DISPROVEN.** Searched history and working trees of the related private repos for `measure_relevance|replay_rg|replay_relevance|evidence-relevance`: zero references to this harness exist outside `evidence-relevance/`; the PR-number hits that prompted the question belong to unrelated work. No stale copy or canonical replacement of this tooling exists to own or track.
